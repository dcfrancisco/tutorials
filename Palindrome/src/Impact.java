...
{
    Animator anim;		//object that draws on canvas
    Ticker tick;		//object time keeper
    Thread anim_thread;	//thread running Animator
    Thread tick_thread;	//thread running Ticker
